...
export const Route = createFileRoute('/admin/settings/teams')({
  loader: async ({ context }) => {
    await context.queryClient.ensureQueryData(settingsQueries.teams())
  },
  component: TeamsPage,
})
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <PageHeader
        icon={UserGroupIcon}
        title="Teams"
        description="Group teammates so conversations can be assigned to a whole team"
        action={
      ...
      <TeamDialog open={dialogOpen} onOpenChange={setDialogOpen} team={editing} />
